<?php
/**
 * ProcessLoginRequestProcessor Class File
 *
 ...
 * @subpackage Account
 */
class ProcessLoginRequestProcessor extends RequestProcessor {
    ...
    public function processRequest() {
		...
		$username = $this->bean->getPOST('username');
		$password = hash(self::STRONG_HASH, $this->bean->getPOST('password') );
		...
		if( $userDTO->getUserID() !== null){
			...
			$jsonRetval =  "{'LOGGED_IN': 'true', 'PROFILE_ID': '" . $_SESSION['MAIN_PROFILE_ID'] . "'}";
