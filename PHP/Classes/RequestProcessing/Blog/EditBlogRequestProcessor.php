...
class EditBlogRequestProcessor extends RequestProcessor {
    ...
    public function processRequest() {
		...
		$inputValues = array();
    	$inputValues[ 'inputBlogId' ] = $this->bean->getPOST( 'blogID' );
    	$inputValues[ 'inputBlogTitle' ] = $this->bean->getPOST( 'newBlogTitle' );
    	$inputValues[ 'inputBlogContent' ] = $this->bean->getPOST( 'newBlogContent' );
