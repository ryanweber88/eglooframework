...
class CreateImageElementRequestProcessor extends RequestProcessor {
    ...
    public function processRequest() {
        ...
        $imageID = $this->bean->getPOST( 'imageID' );
        $imageMIMEType = str_replace( '_', '/', $this->bean->getPOST( 'imageMIMEType' ) );

        $imageElementTitle = $this->bean->getPOST( 'imageElementTitle' );
        $imageElementSummary = $this->bean->getPOST( 'imageElementSummary' );
