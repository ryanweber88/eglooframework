...
class SetUserProfileDataRequestProcessor extends RequestProcessor {
    ...
    public function processRequest() {
        $profileID = $this->bean->getGET( 'profileID' );
        ...
        $userProfileDTO->setSex( $this->bean->getPOST( 'gender' ) );

        $userBirthDay = $this->bean->getPOST( 'userBirthDay' );
        $userBirthMonth = $this->bean->getPOST( 'userBirthMonth' );
        $userBirthYear = $this->bean->getPOST( 'userBirthYear' );
