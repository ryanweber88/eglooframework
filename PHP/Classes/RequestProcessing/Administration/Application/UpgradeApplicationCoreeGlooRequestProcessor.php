<?php
/**
 * UpgradeApplicationCoreeGlooRequestProcessor Class File
 *
 ...
 */
class UpgradeApplicationCoreeGlooRequestProcessor extends RequestProcessor {
    ...
    public function processRequest() {
        eGlooLogger::writeLog( eGlooLogger::DEBUG, "UpgradeApplicationCoreeGlooRequestProcessor: Entered processRequest()" );
		...
		eGlooLogger::writeLog( eGlooLogger::DEBUG, "UpgradeApplicationCoreeGlooRequestProcessor: Echoing Response" );
        ...
        eGlooLogger::writeLog( eGlooLogger::DEBUG, "UpgradeApplicationCoreeGlooRequestProcessor: Exiting processRequest()" );
    }
