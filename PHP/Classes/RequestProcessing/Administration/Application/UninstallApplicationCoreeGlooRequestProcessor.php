<?php
/**
 * UninstallApplicationCoreeGlooRequestProcessor Class File
 *
 * Contains the class definition for the UninstallApplicationCoreeGlooRequestProcessor, a
...
/**
 * Uninstall Application Core eGloo Request Processor
 *
 ...
 */
class UninstallApplicationCoreeGlooRequestProcessor extends RequestProcessor {
    ...
    public function processRequest() {
        eGlooLogger::writeLog( eGlooLogger::DEBUG, "UninstallApplicationCoreeGlooRequestProcessor: Entered processRequest()" );
		...
		eGlooLogger::writeLog( eGlooLogger::DEBUG, "UninstallApplicationCoreeGlooRequestProcessor: Echoing Response" );
        ...
        eGlooLogger::writeLog( eGlooLogger::DEBUG, "UninstallApplicationCoreeGlooRequestProcessor: Exiting processRequest()" );
    }
