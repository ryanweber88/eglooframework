 ...
 *
 * Contains the class definition for the eGloo\Combine\Application
 * 
 ...
 * @subpackage Combines
 */
class Application extends Combine {
	...
	protected function create() {
		...
		if ( isset($this->_command_arguments[0]) ) {
			...
			$skeleton = ApplicationObject::getFreshSkeleton( $application_name );
	...
	protected function install() {
		...
		if ( isset($this->_command_arguments[0]) ) {
			...
			$application = new ApplicationObject( $application_name );
