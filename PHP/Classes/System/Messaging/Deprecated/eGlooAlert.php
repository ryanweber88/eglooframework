...
class eGlooAlert {
	...
	public static function sendEmailAlert( $subject = '', $message = '', $trigger_type = null, $additional_recipients = null ) {
		...
		if ( is_array($additional_recipients) && !empty($additional_recipients) ) {
